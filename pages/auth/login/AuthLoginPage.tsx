...
const AuthLoginPage = ({navigation}: {navigation: any}) => {
    ...
    return <View style={tw`w-full h-full`}>
        <Image
            ...
            source={require('../../../assets/images/server/bg.jpg')}
        />
        <Image
        ...
        <View style={tw`absolute top-0 right-0 bottom-0 left-0 justify-center items-center`}>
            <View style={[tw`bg-black bg-opacity-75 p-4 text-white`, styles.form]}>
                ...
                <View style={tw`mt-4`}>
                    <Pressable style={tw`bg-white w-full bg-opacity-75 text-black px-2 h-10 font-semibold border border-white flex items-center justify-center`}
                               onPress={onLogin}>
                        <Text>Login</Text>
                    </Pressable>
                </View>
